<template>
  <div class="sub-filter" v-if="filterData && !filterLoading">
    <div class="item">
      ...
      <div class="body">
        <a class="ellipsis" :title="item.name" @click="changeBrand(item.id)"
          :class="{ active: item.id === filterData.selectedBrand }" href="javascript:;" v-for="item in filterData.brands"
    ...
    <div class="item" v-for="item in filterData.saleProperties" :key="item.id">
      ...
      <div class="body">
        <a class="ellipsis" :title="prop.name" @click="changeProp(item, prop.id)"
          :class="{ active: prop.id === item.selectedProp }" href="javascript:;" v-for="prop in item.properties"
